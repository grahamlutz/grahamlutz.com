...
$book_landing_page_settings = array( 'default', 'home', 'breadcrumb', 'custom' );
...
function book_landing_page_customizer_js() {
	wp_enqueue_script( 'book-landing-page-customizer-js', get_template_directory_uri() . '/inc/js/customizer.js', array("jquery"), '20160512', true  );	
	
	$book_landing_page_array = array(
    	'newsletter'      => is_newsletter_activated()
	);
