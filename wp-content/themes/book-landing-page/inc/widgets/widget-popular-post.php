...
// register Book_Landing_Page_Popular_Post widget
function book_landing_page_register_popular_post_widget() {
    register_widget( 'Book_Landing_Page_Popular_Post' );
}
add_action( 'widgets_init', 'book_landing_page_register_popular_post_widget' );
 
 /**
 * Adds Book_Landing_Page_Popular_Post widget.
 */
class Book_Landing_Page_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'book_landing_page_popular_post', // Base ID
			esc_html__( 'RARA: Popular Post', 'book-landing-page' ), // Name
			array( 'description' => esc_html__( 'A Popular Post Widget', 'book-landing-page' ), ) // Args
		);
	}
...
} // class Book_Landing_Page_Popular_Post 